...
public class ReservationsResource {
  ...
  public RestResponse<TemplateInstance> create(@RestForm LocalDate startDate,
    ...
    Reservation reservation = Reservation.fromCarIdStartDtEndDt(carId, startDate, endDate);
  ...
  public static class Templates {
    ...
    public static native TemplateInstance index(LocalDate startDate, LocalDate endDate,
        String name);
